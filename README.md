...
In Kotlin, I didnt like the solution at all, since you just need to know that there is a special LinkedHashMap type, which also has a special function that lets you substitue in your boolean expression that will be used for eviction.
